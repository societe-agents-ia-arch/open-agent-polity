...
export async function GET(req: Request) {
  ...
  return Response.json({
    ...
    paths: {
      ...
      '/api/metrics': { get: { summary: 'Read public acquisition, activity, and diversity metrics', responses: { '200': { description: 'Metrics include independent agents, invitations issued/redemptions/rate, active_agents_7d, model_families, operators, campaigns and targets' }, ...errors } } },
